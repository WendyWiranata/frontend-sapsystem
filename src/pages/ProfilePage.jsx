    ...
    <div className="p-6">
      ...
      <div className="bg-white shadow-md rounded-lg p-6 ">
        ...
        <div className="mb-4">
          ...
          <p className="text-lg text-black font-semibold">{user.role}</p>
        </div>
        {user.perusahaan && (
          <div className="mb-4">
            <p className="text-gray-600">Perusahaan:</p>
            <p className="text-lg text-black font-semibold">{user.perusahaan.nama}</p>
          </div>
        )}
        {user.karyawan && (
          <>
            <div className="mb-4">
              ...
              <p className="text-lg text-black font-semibold">{user.karyawan.jabatan}</p>
            </div>
            <div className="mb-4">
              <p className="text-gray-600">Departemen:</p>
              <p className="text-lg text-black font-semibold">{user.karyawan.departemen}</p>
            </div>
          </>
        )}
      </div>
